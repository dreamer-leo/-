...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'id', width: 100, title: 'ID', sort: true}
      ,{field: 'reviewers', title: '评价者', minWidth: 100}
      ,{field: 'content', title: '评价内容', minWidth: 100}
      ,{field: 'commtime', title: '评价时间', minWidth: 100, sort: true}
  ...
  table.on('tool(LAY-app-content-comm)', function(obj){
    var data = obj.data;
    if(obj.event === 'del'){
      layer.confirm('确定删除此条评价？', function(index){
        obj.del();
        layer.close(index);
      });
    } else if(obj.event === 'edit') {
