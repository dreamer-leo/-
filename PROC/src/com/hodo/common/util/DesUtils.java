...
public class DesUtils {
    ...
    public void doEncryptFile(String filePath,String savePath) throws FileNotFoundException {
        ...
        savePath = savePath+ "/mi-" + originFile.getName();
    ...
    public void doDecryptFile(String filePath,String savePath) throws Exception
    {
        ...
        savePath = savePath+ "/re-" + originFile.getName();
    ...
    public static void main(String[] args)throws Exception {
        DesUtils desUtils = new DesUtils("aaa");
        desUtils.doEncryptFile("e:/a.txt", "e:/b");     //加密
        desUtils.doDecryptFile("e:/b/mi-a.txt","e:/b"); //解密
    }
