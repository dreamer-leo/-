package com.hodo.common.util.mail;
...
public class SendMail {
	...
	public SendMail() {
        ...
        String sendEmailAccount = properties.getProperty("sendEmailAccount");
        String sendEmailPassword = properties.getProperty("sendEmailPassword");
        String sendEmailSMTPHost = properties.getProperty("sendEmailSMTPHost");
        SendMail.sendEmailAccount=sendEmailAccount;
        SendMail.sendEmailPassword=sendEmailPassword;
        SendMail.sendEmailSMTPHost=sendEmailSMTPHost;
	}
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
		...
		// 设置发件人姓名和编码格式
		message.setFrom(new InternetAddress(sendMail, "尚尚签音乐系统", "UTF-8"));
	...
	public void test(){
		...
		s.sendMail("guodongshengabc@163.com", "测试邮件123");
	}
